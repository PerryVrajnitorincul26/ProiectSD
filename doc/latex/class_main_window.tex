...
\item 
\mbox{\Hypertarget{class_main_window_aa16dc4b57bc0e7cdfd5fcbcd80536463}\label{class_main_window_aa16dc4b57bc0e7cdfd5fcbcd80536463}} 
void {\bfseries set\+Image} (QString newimg)
...
Another prime example of the \char`\"{}\+Hey man if it works approach\char`\"{} to software engineering This constructor does so much because i would\textquotesingle{}ve had to reimplement way to many functions if i had promoted ui objects to their own types Mostly initializes Ui related attributes 
